...
-- numbers are extremely close - The Second includes "International"  Location
...
Select Location, Population,date, MAX(total_cases) as HighestInfectionCount,  Max((CAST(total_cases AS numeric)/population))*100 as PercentPopulationInfected
From PortfolioProject..CovidDeaths
--Where location like '%states%'
